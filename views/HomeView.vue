...
<template>
  ...
  <div v-else class="home-stage aspect-[390/799] w-full md:aspect-auto md:min-h-[799px]">
    ...
    <section class="home-hero relative h-[379px] overflow-hidden bg-gradient-to-b from-[#FDDFDD] to-white md:h-[440px]">
      ...
      <h1 class="hero-title absolute left-[44px] top-[61px] text-[16.4px] font-bold leading-[26px] tracking-[-0.577px] text-[#292934] md:left-16 md:top-14 md:w-[280px] md:text-[21px] md:leading-[1.45]">
        {{ dashboard.groomName }}님과 {{ dashboard.brideName }}님은<br />
        <span class="text-[23.8px] leading-[37px] tracking-[-0.72px] text-[#FF6464] md:text-[31px] md:leading-[1.3]">{{ formatWon(dashboard.totalAccumulatedAmount) }}</span>
        모았어요!
      </h1>

      <button type="button" class="hero-confirm absolute left-[44px] top-[128px] flex h-[25px] w-[62px] items-center rounded-full bg-[#FF6464] pl-3 text-[12px] font-bold leading-[14px] text-[#FBF0EF] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.28)] md:left-16 md:top-[145px] md:h-[34px] md:w-20 md:text-sm">
        확인
        <ChevronRight class="ml-1 h-4 w-4" :stroke-width="2" />
      </button>

      <div class="hero-stats absolute left-[40px] top-[178px] flex h-[35px] w-[123px] gap-[7px] md:left-[58px] md:top-[210px] md:scale-[1.12] md:origin-top-left">
    ...
    <section class="home-content relative -mt-[14px] h-[393px] rounded-t-[24px] bg-white px-5 pt-[18px] md:h-auto md:min-h-[359px] md:px-10 md:pb-9 md:pt-5">
      ...
      <div class="goal-grid mt-[10px] flex h-[144px] gap-[13px] py-[5px] md:h-auto">
        <article class="goal-card h-[134px] w-[164px] rounded-2xl border border-white/90 bg-[#FFF1EF] p-4 md:h-[150px] md:w-auto md:flex-1 md:p-[18px]">

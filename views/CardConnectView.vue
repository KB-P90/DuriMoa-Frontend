    ...
    >
      ...
      <main class="flex flex-1 flex-col px-3 pt-5">
        ...
        >
          ...
          >
            <img :src="card.image" :alt="`${card.company} ${card.cardName}`" class="h-[68px] w-[112px] shrink-0 rounded-lg object-cover shadow-[0_4px_6px_rgba(34,34,43,0.14)]" />
            <span class="min-w-0">
              <strong class="block truncate text-sm font-extrabold leading-5">{{ card.cardName }}</strong>

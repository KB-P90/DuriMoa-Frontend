...
import { ProgressViewSkeleton } from '@/components/skeleton/progress';
...
const activeTab = ref<(typeof PROGRESS_TABS)[number]['key']>('overall');
</script>
...
<template>
  <div class="whitespace-nowrap">
    ...
    <ProgressViewSkeleton v-if="progressStore.loading" />
      ...
      >
        ...
        >
          <button
            ...
            class="relative flex-1 cursor-pointer whitespace-nowrap pb-3 text-base font-semibold"
            :class="[
              activeTab === tab.key
                ? `text-brand after:content-[''] after:absolute after:w-full after:left-0 after:-bottom-px after:h-[3.5px] after:bg-brand`
                : 'text-dm-gray-dark',
            ]"
          >
            {{ tab.label }}

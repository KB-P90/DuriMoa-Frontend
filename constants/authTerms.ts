// 백엔드 연결 전 약관 전문 화면을 확인하기 위한 임시 상수 데이터다.
const AUTH_TERM_PAGES = {
  service: {
    title: '이용약관',
  ...
  notification: {
    title: '알림 수신 동의',
    intro:
      '알림 수신은 선택 사항이며, 동의하지 않아도 기본 서비스를 이용할 수 있습니다. 동의 시 아래 알림을 푸시로 받아볼 수 있어요.',
    sections: [
      {
        heading: '결혼 시안 관련 알림',
        paragraphs: [
...
export default AUTH_TERM_PAGES;

...
// 약관 테스트 데이터가 없어도 라우트를 빌드할 수 있도록 선택적으로 불러온다.
const TERM_PAGE_MODULES = import.meta.glob('../../constants/authTerms.ts', {
  eager: true,
});

// 테스트 데이터 파일을 제외한 환경에서는 빈 약관 데이터를 사용한다.
...
// 약관 식별자와 테스트 데이터를 조합한 회원가입 약관 라우트다.
